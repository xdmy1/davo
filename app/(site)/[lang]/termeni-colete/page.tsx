...
export async function generateMetadata({
  ...
  const t = dict(lang);
  return {
    title: t.tcParcelsPage.metaTitle,
    description: t.tcParcelsPage.metaDescription,
    alternates: {
      canonical: localePath(lang, "/termeni-colete"),
      languages: {
        ro: localePath("ro", "/termeni-colete"),
        ru: localePath("ru", "/termeni-colete"),
      },
    },
  };
}

export default async function TermeniColetePage({
  params,
}: {
  params: Promise<{ lang: string }>;
}) {
